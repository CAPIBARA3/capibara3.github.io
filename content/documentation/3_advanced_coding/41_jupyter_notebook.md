...
Your browser will open to `localhost:8888` showing your file browser. If you have VS Code, you can also run notebooks directly in the editor (see [X Code Editors and IDEs](code_editors.md)).
...
Now that you can run Python interactively, let's learn about powerful data and visualization libraries: [11 NumPy and Pandas](43_numpy_pandas.md).
